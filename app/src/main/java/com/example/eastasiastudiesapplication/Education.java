...
public class Education extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        h6 = getActivity().findViewById(R.id.textViewEducationH6);
        h7 = getActivity().findViewById(R.id.textViewEducationH7);
        h8 = getActivity().findViewById(R.id.textViewEducationH8);
        h9 = getActivity().findViewById(R.id.textViewEducationH9);
        h10 = getActivity().findViewById(R.id.textViewEducationH10);
        h11 = getActivity().findViewById(R.id.textViewEducationH11);
        h12 = getActivity().findViewById(R.id.textViewEducationH12);
        h13 = getActivity().findViewById(R.id.textViewEducationH13);
        h14 = getActivity().findViewById(R.id.textViewEducationH14);
        h15 = getActivity().findViewById(R.id.textViewEducationH15);
        h16 = getActivity().findViewById(R.id.textViewEducationH16);
        h17 = getActivity().findViewById(R.id.textViewEducationH17);
        h18 = getActivity().findViewById(R.id.textViewEducationH18);
        h19 = getActivity().findViewById(R.id.textViewEducationH19);
        h20 = getActivity().findViewById(R.id.textViewEducationH20);
        h21 = getActivity().findViewById(R.id.textViewEducationH21);
        h22 = getActivity().findViewById(R.id.textViewEducationH22);
        h23 = getActivity().findViewById(R.id.textViewEducationH23);
        h24 = getActivity().findViewById(R.id.textViewEducationH24);
        h25 = getActivity().findViewById(R.id.textViewEducationH25);

        l6 = getActivity().findViewById(R.id.textViewEducationL6);
        l7 = getActivity().findViewById(R.id.textViewEducationL7);
        l8 = getActivity().findViewById(R.id.textViewEducationL8);
        l9 = getActivity().findViewById(R.id.textViewEducationL9);
        l10 = getActivity().findViewById(R.id.textViewEducationL10);
        l11 = getActivity().findViewById(R.id.textViewEducationL11);
        l12 = getActivity().findViewById(R.id.textViewEducationL12);
        l13 = getActivity().findViewById(R.id.textViewEducationL13);
        l14 = getActivity().findViewById(R.id.textViewEducationL14);
        l15 = getActivity().findViewById(R.id.textViewEducationL15);
        l16 = getActivity().findViewById(R.id.textViewEducationL16);
        l17 = getActivity().findViewById(R.id.textViewEducationL17);
        l18 = getActivity().findViewById(R.id.textViewEducationL18);
        l19 = getActivity().findViewById(R.id.textViewEducationL19);
        l20 = getActivity().findViewById(R.id.textViewEducationL20);
        l21 = getActivity().findViewById(R.id.textViewEducationL21);
        l22 = getActivity().findViewById(R.id.textViewEducationL22);
        l23 = getActivity().findViewById(R.id.textViewEducationL23);
        l24 = getActivity().findViewById(R.id.textViewEducationL24);
        l25 = getActivity().findViewById(R.id.textViewEducationL25);
