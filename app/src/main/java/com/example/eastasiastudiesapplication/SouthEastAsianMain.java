...
public class SouthEastAsianMain extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    //variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_south_east_asian_main);
        ...
        myViewModel.setData("SouthEastAsia");
