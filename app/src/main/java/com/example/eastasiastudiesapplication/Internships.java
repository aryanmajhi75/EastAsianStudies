...
public class Internships extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        h6 = getActivity().findViewById(R.id.textViewInternshipH6);
        h7 = getActivity().findViewById(R.id.textViewInternshipH7);
        h8 = getActivity().findViewById(R.id.textViewInternshipH8);
        h9 = getActivity().findViewById(R.id.textViewInternshipH9);
        h10 = getActivity().findViewById(R.id.textViewInternshipH10);
        h11 = getActivity().findViewById(R.id.textViewInternshipH11);
        h12 = getActivity().findViewById(R.id.textViewInternshipH12);
        h13 = getActivity().findViewById(R.id.textViewInternshipH13);
        h14 = getActivity().findViewById(R.id.textViewInternshipH14);
        h15 = getActivity().findViewById(R.id.textViewInternshipH15);
        h16 = getActivity().findViewById(R.id.textViewInternshipH16);
        h17 = getActivity().findViewById(R.id.textViewInternshipH17);
        h18 = getActivity().findViewById(R.id.textViewInternshipH18);
        h19 = getActivity().findViewById(R.id.textViewInternshipH19);
        h20 = getActivity().findViewById(R.id.textViewInternshipH20);
        h21 = getActivity().findViewById(R.id.textViewInternshipH21);
        h22 = getActivity().findViewById(R.id.textViewInternshipH22);
        h23 = getActivity().findViewById(R.id.textViewInternshipH23);
        h24 = getActivity().findViewById(R.id.textViewInternshipH24);
        h25 = getActivity().findViewById(R.id.textViewInternshipH25);

        l6 = getActivity().findViewById(R.id.textViewInternshipL6);
        l7 = getActivity().findViewById(R.id.textViewInternshipL7);
        l8 = getActivity().findViewById(R.id.textViewInternshipL8);
        l9 = getActivity().findViewById(R.id.textViewInternshipL9);
        l10 = getActivity().findViewById(R.id.textViewInternshipL10);
        l11 = getActivity().findViewById(R.id.textViewInternshipL11);
        l12 = getActivity().findViewById(R.id.textViewInternshipL12);
        l13 = getActivity().findViewById(R.id.textViewInternshipL13);
        l14 = getActivity().findViewById(R.id.textViewInternshipL14);
        l15 = getActivity().findViewById(R.id.textViewInternshipL15);
        l16 = getActivity().findViewById(R.id.textViewInternshipL16);
        l17 = getActivity().findViewById(R.id.textViewInternshipL17);
        l18 = getActivity().findViewById(R.id.textViewInternshipL18);
        l19 = getActivity().findViewById(R.id.textViewInternshipL19);
        l20 = getActivity().findViewById(R.id.textViewInternshipL20);
        l21 = getActivity().findViewById(R.id.textViewInternshipL21);
        l22 = getActivity().findViewById(R.id.textViewInternshipL22);
        l23 = getActivity().findViewById(R.id.textViewInternshipL23);
        l24 = getActivity().findViewById(R.id.textViewInternshipL24);
        l25 = getActivity().findViewById(R.id.textViewInternshipL25);
